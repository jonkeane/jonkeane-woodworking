 ...
 * 
*/
function(e){"use strict";"function"==typeof define&&define.amd?define(["jquery","nanogallery2"],e):"object"==typeof exports&&"function"==typeof require?e(require(["jquery","nanogallery2"])):e(jQuery)}((function(e){jQuery.nanogallery2.data_flickr=function(e,t){var n=e,i={url:function(){return"https://api.flickr.com/services/rest/"},thumbSize:"               sq",thumbAvailableSizes:new Array(75,100,150,240,500,640),thumbAvailableSizesStr:new Array("sq","t","q","s","m","z"),photoSize:"0",photoAvailableSizes:new Array(75,100,150,240,500,640,1024,1024,1600,2048,1e4),photoAvailableSizesStr:new Array("sq","t","q","s","m","z","b","l","h","k","o")},a=function(e,t,a,o){""==n.O.flickrAPIKey&&d(n,"Please set your Flickr API Key (option flickrAPIKey)");var s=NGY2Item.GetIdx(n,e),u="",m="image";"NONE"==n.O.photoset.toUpperCase()||"NONE"==n.O.album.toUpperCase()?u=i.url()+"?&method=flickr.people.getPublicPhotos&api_key="+n.O.flickrAPIKey+"&user_id="+n.O.userID+"&extras=description,views,tags,url_o,url_sq,url_t,url_q,url_s,url_m,url_z,url_b,url_h,url_k&per_page=500&format=json":0==n.I[s].GetID()?(u=i.url()+"?&method=flickr.photosets.getList&api_key="+n.O.flickrAPIKey+"&user_id="+n.O.userID+"&per_page=500&primary_photo_extras=tags,url_o,url_sq,url_t,url_q,url_s,url_m,url_l,url_z,url_b,url_h,url_k&format=json",m="album"):u=i.url()+"?&method=flickr.photosets.getPhotos&api_key="+n.O.flickrAPIKey+"&photoset_id="+n.I[s].GetID()+"&extras=description,views,tags,url_o,url_sq,url_t,url_q,url_s,url_m,url_l,url_z,url_b,url_h,url_k&format=json",n.O.debugMode&&console.log("Flickr URL: "+u),h(!0),jQuery.ajaxSetup({cache:!1}),jQuery.support.cors=!0;var p=setTimeout((function(){h(!1),d(n,"Could not retrieve AJAX data...")}),6e4),f=[],b=function(i,u){jQuery.getJSON(i+"&page="+u+"&jsoncallback=?",(function(v,O,y){var G=0;if("album"==m){if(void 0!==v.stat&&"fail"===v.stat)return d(n,"Could not retrieve Flickr album list: "+v.message+" (code: "+v.code+")."),!1;f=f.concat(v.photosets.photoset),G=v.photosets.pages}else if("NONE"==n.O.photoset.toUpperCase()||"NONE"==n.O.album.toUpperCase())f=f.concat(v.photos.photo),G=v.photos.pages;else{if(void 0!==v.stat&&"fail"===v.stat)return d(n,"Could not retrieve Flickr album: "+v.message+" (code: "+v.code+")."),!1;""==n.I[s].title&&(n.I[s].title=v.photoset.title),f=f.concat(v.photoset.photo),G=v.photoset.pages}G>u?b(i,u+1):(clearTimeout(p),h(!1),f=c(f,n.O.tagBlockList),"album"==m?l(s,e,f):r(s,e,f),g(e),null!=t&&t(a,o,null))})).fail((function(e,t,i){clearTimeout(p),h(!1),d(n,"Could not retrieve Flickr ajax data: "+t+", "+i)}))};b(u,1)};function o(e,t){jQuery.ajaxSetup({cache:!1}),jQuery.support.cors=!0;var a=setTimeout((function(){d("Could not retrieve AJAX data...")}),6e4);url=i.url()+"?&method=flickr.photos.getExif&api_key="+n.O.flickrAPIKey+"&photo_id="+e+"&format=json",jQuery.getJSON(url+"&jsoncallback=?",(function(e,n,i){void 0!==e.photo.camera&&(t.exif.model=e.photo.camera);var o=e.photo.exif.filter((function(e){return"LensModel"==e.tag}));o.length>=1&&(t.exif.lens=o[0].raw._content);var r=e.photo.exif.filter((function(e){return"Flash"==e.tag}));r.length>=1&&(t.exif.flash=r[0].raw._content);var l=e.photo.exif.filter((function(e){return"FocalLength"==e.tag}));l.length>=1&&(t.exif.focallength=l[0].raw._content);var s=e.photo.exif.filter((function(e){return"FNumber"==e.tag}));s.length>=1&&(t.exif.fstop=s[0].raw._content);var u=e.photo.exif.filter((function(e){return"ExposureTime"==e.tag}));u.length>=1&&(t.exif.exposure=u[0].raw._content);var c=e.photo.exif.filter((function(e){return"ISO"==e.tag}));c.length>=1&&(t.exif.iso=c[0].raw._content);var h=e.photo.exif.filter((function(e){return"DateTimeOriginal"==e.tag}));h.length>=1&&(t.exif.time=h[0].raw._content);var d=e.photo.exif.filter((function(e){return"LOLcation"==e.tag}));d.length>=1&&(t.exif.location=d[0].raw._content);var m=e.photo.exif.filter((function(e){return"OwnerName"==e.tag}));m.length>=1&&(t.author=m[0].raw._content),clearTimeout(a)})).fail((function(e,t,n){console.log("Unable to get EXIF data from Flickr")}))}function r(e,t,a){n.O.debugMode&&(console.log("Flickr parse photos:"),console.dir(a)),jQuery.each(a,(function(e,a){var r=a.id,l=a.url_sq,u=a.title;""!=n.O.thumbnailLabel.get("title")&&(u=m(l));var c=a.description._content,h=75,d=75,p=i.photoAvailableSizesStr.length-1;n.O.flickrSkipOriginal&&p--;for(e=p;e>=0;e--)if(null!=a["url_"+i.photoAvailableSizesStr[e]]){l=a["url_"+i.photoAvailableSizesStr[e]],h=parseInt(a["width_"+i.photoAvailableSizesStr[e]]),d=parseInt(a["height_"+i.photoAvailableSizesStr[e]]);break}var g={};for(var f in a)0!=f.indexOf("height_")&&0!=f.indexOf("width_")&&0!=f.indexOf("url_")||(g[f]=a[f]);var b=void 0!==a.tags?a.tags:"",v=NGY2Item.New(n,u,c,r,t,"image",b);n.O.flickrExif&&o(r,v),v.setMediaURL(l,"img"),v.imageWidth=h,v.imageHeight=d;var O={url:{l1:{xs:"",sm:"",me:"",la:"",xl:""},lN:{xs:"",sm:"",me:"",la:"",xl:""}},width:{l1:{xs:0,sm:0,me:0,la:0,xl:0},lN:{xs:0,sm:0,me:0,la:0,xl:0}},height:{l1:{xs:0,sm:0,me:0,la:0,xl:0},lN:{xs:0,sm:0,me:0,la:0,xl:0}}};O=s(O,a,"l1"),O=s(O,a,"lN"),v.thumbs=O;var y=n.O.fnProcessData;null!==y&&("function"==typeof y?y(v,"flickr",a):window[y](v,"flickr",a))})),n.I[e].contentIsLoaded=!0}function l(e,t,i){n.O.debugMode&&(console.log("Flickr parse list of albums:"),console.dir(i)),jQuery.each(i,(function(e,i){var a=i.title._content;if(0==i.visibility_can_see_set)return!0;if(p(a,i.id)){var o=i.id,r=null!=i.description._content?i.description._content:"",l={};for(var u in i.primary_photo_extras)l[u]=i.primary_photo_extras[u];var c="";void 0!==i.primary_photo_extras&&void 0!==i.primary_photo_extras.tags&&(c=i.primary_photo_extras.tags);var h=NGY2Item.New(n,a,r,o,t,"album",c);h.numberItems=i.photos,h.thumbSizes=l;var d={url:{l1:{xs:"",sm:"",me:"",la:"",xl:""},lN:{xs:"",sm:"",me:"",la:"",xl:""}},width:{l1:{xs:0,sm:0,me:0,la:0,xl:0},lN:{xs:0,sm:0,me:0,la:0,xl:0}},height:{l1:{xs:0,sm:0,me:0,la:0,xl:0},lN:{xs:0,sm:0,me:0,la:0,xl:0}}};d=s(d,i.primary_photo_extras,"l1"),d=s(d,i.primary_photo_extras,"lN"),h.thumbs=d;var m=n.O.fnProcessData;null!==m&&("function"==typeof m?m(h,"flickr",i):window[m](h,"flickr",i))}})),n.I[e].contentIsLoaded=!0}function s(e,t,i){var a=1;!0===n.tn.opt[i].crop&&(a=n.O.thumbnailCropScaleFactor);for(var o=["xs","sm","me","la","xl"],r=0;r<o.length;r++)if("auto"==n.tn.settings.width[i][o[r]]||""==n.tn.settings.width[i][o[r]]){let l=u("height_",Math.ceil(n.tn.settings.height[i][o[r]]*n.tn.scale*a*n.tn.settings.mosaic[i+"Factor"].h[o[r]]),t);e.url[i][o[r]]=l.url,e.width[i][o[r]]=l.width,e.height[i][o[r]]=l.height}else if("auto"==n.tn.settings.height[i][o[r]]||""==n.tn.settings.height[i][o[r]]){let l=u("width_",Math.ceil(n.tn.settings.width[i][o[r]]*n.tn.scale*a*n.tn.settings.mosaic[i+"Factor"].w[o[r]]),t);e.url[i][o[r]]=l.url,e.width[i][o[r]]=l.width,e.height[i][o[r]]=l.height}else{let l="height_",s=Math.ceil(n.tn.settings.height[i][o[r]]*n.tn.scale*a*n.tn.settings.mosaic[i+"Factor"].h[o[r]]);n.tn.settings.width[i][o[r]]>n.tn.settings.height[i][o[r]]&&(l="width_",s=Math.ceil(n.tn.settings.width[i][o[r]]*n.tn.scale*a*n.tn.settings.mosaic[i+"Factor"].w[o[r]]));let c=u(l,s,t);e.url[i][o[r]]=c.url,e.width[i][o[r]]=c.width,e.height[i][o[r]]=c.height}return e}function u(e,t,n){for(var a={url:"",width:0,height:0},o=0,r=0;r<i.thumbAvailableSizes.length;r++){var l=n[e+i.photoAvailableSizesStr[r]];if(null!=l&&(o=r,l>=t))break}var s=i.photoAvailableSizesStr[o];return a.url=n["url_"+s],a.width=parseInt(n["width_"+s]),a.height=parseInt(n["height_"+s]),a}var c=function(e,t){return""!=t&&null!=e&&(e=e.filter((function(e){var n=new RegExp(t,"i"),i=[e.tags];return Array.isArray(e.tags)&&(i=e.tags),!i.some((function(e){return n.test(e)}))}))),e};var h=NGY2Tools.PreloaderDisplay.bind(n),d=NGY2Tools.NanoAlert,m=NGY2Tools.GetImageTitleFromURL.bind(n),p=NGY2Tools.FilterAlbumName.bind(n),g=NGY2Tools.AlbumPostProcess.bind(n);switch(t){case"AlbumGetContent":var f=arguments[2],b=arguments[3],v=arguments[4],O=arguments[5];a(f,b,v,O)}}}));